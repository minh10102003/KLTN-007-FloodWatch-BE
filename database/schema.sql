...
-- -----------------------------------------------------------------------------
-- PHẦN 4A: BẢNG ROAD GRAPH (sau sensors — road_edges FK tới sensors)
-- -----------------------------------------------------------------------------
...
VALUES
  ...
  ('NODE_007', 'Bình Quới (P.28) - NODE_007 (LoRa/MQTT)', ST_SetSRID(ST_MakePoint(106.735, 10.828), 4326)::geography, 'Real_LoRa_Node', 'HC-SR04', '2024-01-01', 150.0),
