...
# Mỗi đầu đường lấy N node gần nhất; tối đa N² lần A* / request. Giảm (vd. 3) nếu FE/timeout trên đồ thị rất lớn.
_ROUTING_SNAP_RAW = _int("ROUTING_SNAP_CANDIDATE_LIMIT", 6)
ROUTING_SNAP_CANDIDATE_LIMIT = max(1, min(8, _ROUTING_SNAP_RAW))
...
ROUTING_ENABLE_BIDIRECTIONAL = _bool("ROUTING_ENABLE_BIDIRECTIONAL", True)
