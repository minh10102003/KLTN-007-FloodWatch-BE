/**
 * Cột name + display_meta cho emergency_subscriptions.
...
async function run() {
    ...
    try {
        const sqlPath = path.join(__dirname, '..', 'database', 'add_emergency_subscription_name.sql');
        await client.query(fs.readFileSync(sqlPath, 'utf8'));
        console.log('✅ Đã thêm name + display_meta cho emergency_subscriptions.');
    } catch (err) {
